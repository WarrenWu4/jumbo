            ...
            <div className="flex flex-col gap-y-8">
                ...
                <div className="flex">
                    ...
                    <svg viewBox="0 0 452 437" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <rect x="87.5" y="132.081" width="276" height="172" rx="68" stroke="currentColor" stroke-width="12"/>
                        <path d="M118.5 233.581V195.581C124.5 153.081 200.7 161.781 225.5 168.581" stroke="currentColor" stroke-width="12" fill="currentColor" stroke-linecap="round"/>
                    </svg>
